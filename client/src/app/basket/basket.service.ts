...
export class BasketService {
  ...
  private basketSubTotalSource = new BehaviorSubject<BasketTotal | null>(null);
  basketSubTotalSource$= this.basketSubTotalSource.asObservable()
  ...
  deleteBasket(basket: Basket) {
    return this.http.delete(this.baseUrl + 'basket?id=' + basket.id).subscribe({
      next:()=>{
        ...
        this.basketSubTotalSource.next(null);
  ...
  private calculateTotals(){
    ...
    this.basketSubTotalSource.next({shipping,subTotal,total})
  }
